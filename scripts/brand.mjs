// Switch the whole app between brand versions: `node scripts/brand.mjs v2` or `node scripts/brand.mjs c4`.
...
if (!SETS[target]) { console.error('Usage: node scripts/brand.mjs v2|c4'); process.exit(1); }
...
fs.writeFileSync(current, fs.readFileSync(current, 'utf8').replace(/export const BRAND: 'v2' \| 'c4' = '(v2|c4)';/, `export const BRAND: 'v2' | 'c4' = '${target}';`));
