...
export const SEED_INITIAL_GOALS: Goal[] = [
  ...
  },
  {
    id: 'goal-seed-2',
    userId: 'demo-user',
    title: N_('Peak Physical Vitality & Aerobic Engine'),
  ...
  },
  {
    id: 'goal-seed-3',
    userId: 'demo-user',
    title: N_('Unshakable Focus & Identity Standards'),
  ...
  },
  {
    id: 'goal-seed-4',
    userId: 'demo-user',
    title: N_('Financial Sovereignty & Reality Bridge Fund'),
...
export const SEED_INITIAL_MISSIONS: Mission[] = [
  {
    ...
    userId: 'demo-user',
    goalId: 'goal-seed-1',
    title: N_('Complete 45 minutes of focused work on the main project'),
    type: 'daily_quest',
    area: 'Work',
    difficulty: 'medium',
    estimatedMinutes: 45,
  ...
  },
  {
    ...
    userId: 'demo-user',
    goalId: 'goal-seed-1',
    title: N_('Review weekly spending and update savings ledger'),
    type: 'weekly_mission',
    area: 'Money',
    difficulty: 'easy',
    estimatedMinutes: 30,
  ...
  },
  {
    id: 'mission-seed-3',
    userId: 'demo-user',
    title: N_('Complete a 40-minute vigorous training workout'),
    type: 'daily_quest',
    area: 'Health',
    difficulty: 'easy',
    estimatedMinutes: 40,
  ...
  },
  {
    id: 'mission-seed-4',
    userId: 'demo-user',
    title: N_('No scrolling on phone before 9:00 AM'),
    type: 'constraint',
  ...
  },
  {
    ...
    userId: 'demo-user',
    goalId: 'goal-seed-1',
    title: N_('Publish one finished article or public deliverable'),
